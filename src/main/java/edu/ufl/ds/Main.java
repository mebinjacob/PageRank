...
public class Main extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		String[] args_4 = { "src/main/resources/output/outlinks",
				"src/main/resources/output/cleaned" };// "src/main/resources/output/results"
		Cleaner.main(args_4);
		String[] args_5 = { "src/main/resources/output/cleaned",
				"src/main/resources/output/iterations" };// "src/main/resources/output/results"
		PageRanker.main(args_5);
		String[] args_6 = { "src/main/resources/output/iterations7",
